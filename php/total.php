        ...
        <div class="mainSection">
            <div class="row">
                ...
                <div class="col-md-4 total">
                    <input type="text" name="total" value="$12.43" readonly>
                </div>
                <div class="col-md-2"></div>
            </div>
            <div class="row">
                <div class="col-md-2"></div>
                <div class="col-md-4"><h3>Pay with: </h3></div>
                <div class="col-md-4 pMethod"><input type="text" name="paymentMethod" value="Card" readonly></div>
                <div class="col-md-2"></div>
            </div>
        </div>
    </div>
